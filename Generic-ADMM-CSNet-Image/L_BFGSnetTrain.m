%% This is a training code of Generic-ADMM-CSNet for a natural image training dataset by L-BFGS optimizing.
...
%% Loading data
data_dir = './data/Trainingdata/data_H_0.3/train/';
%data_dir = './data/Trainingdata/data_D_0.1/train/';
