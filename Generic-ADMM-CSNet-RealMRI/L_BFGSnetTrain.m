%% This is a training code of Generic-ADMM-CSNet for a real-valued MR training dataset by L-BFGS optimizing.
...
%% Loading data
data_dir = './data/DATA-Pseudo-radial-0.2-real-brain/train/';
